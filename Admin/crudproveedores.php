...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `proveedores` (`nombre`, `dni`, `telefono`) VALUES ('$name', '$dni', '$telefono');";
...
// Cambiar a la consulta correcta para proveedores y filtrar por estado
$vista = "SELECT * FROM `proveedores` WHERE `estado` != 0";
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro?')">Borrar</a>
                            </td>
                        </tr>
                    <?php endwhile ?>
                </tbody>
