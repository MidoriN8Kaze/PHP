...
$sql = "SELECT productos.nombre AS producto,
     proveedores.nombre AS proveedor, compras.cantidad AS cantidad,
      compras.valorunitario AS unidad, compras.valorcompra AS total, compras.fecha AS fecha 
      FROM compras JOIN productos 
      ON compras.idproductos = productos.id 
      JOIN proveedores 
      ON compras.idproveedores = proveedores.id 
